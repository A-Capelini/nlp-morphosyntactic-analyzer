...
# Configuração da página (deve ser obrigatoriamente a primeira instrução do Streamlit)
st.set_page_config(page_title="NLP Analyzer", layout="wide")

# Injeção do CSS para garantir o Design Universal
...
with col1:
    ...
    trees_td = run_top_down(selected_sentence)
...
with col2:
    ...
    trees_bu = run_bottom_up(selected_sentence)
